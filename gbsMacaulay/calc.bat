...
"%M2WINH%\libexec\Macaulay2" -tty -ephase=1 "%M2HOME%/m2/setup.m2" -ephase=0 '-e runStartFunctions()' '-silent' '-e load "!!TODO:FULL PATH TO CODE, e.g. C:/../GBpolysolver/gbsMacaulay/code"'
